<div class="h-[50rem] lg:flex lg:flex-row overflow-y-auto">
    ...
    <div class="lg:w-4/12 flex flex-col bg-white p-5">
        <div class="flex flex-row items-center">
            <div>
                <img src="{{ asset('storage'.auth()->user()->image) }}" class="w-10 h-10 mr-2 rounded-full border border-neutral-300">
            </div>
      ...
      <textarea placeholder="{{ __('Write description...') }}" wire:model="description"
        ...
        <div class="mt-auto">
            <x-button class="w-full justify-center mb-20" wire:click="update">{{ __('Update') }}</x-button>
        </div>
    </div>
</div>